...
const char *ssid =  "cevizli_baklava";   // cannot be longer than 32 characters!
const char *pass =  "291082Ca..";   //
 
const char *mqtt_server = "m20.cloudmqtt.com";
const int  mqtt_port = 20058;
const char *mqtt_user = "dwopjevx";
const char *mqtt_pass = "2o9TTo8Mmiuq";
const char *mqtt_client_name = "organic1"; // Client connections cant have the same connection name
...
void callback(const Publish& pub) {
