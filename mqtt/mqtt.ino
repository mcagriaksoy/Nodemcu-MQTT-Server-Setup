...
const char* ssid = "cevizli_baklava";
const char* password = "291082Ca.."; 
...
const char* server = "io.adafruit.com"; // server or URL of MQTT broker
String clientName = "dwopjevx"; // just a name used to talk to MQTT broker
